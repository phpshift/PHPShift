...
0. "README.md" - (mandatory) general overview of project's Goal, Pages (e.g public/edititem) and Usage;
...
2. "{category_name}.{page_name}.md" - (strict format) Markdown file for category page (e.g public.edititem.md) describing required page's logic and brief technical functionality logic to know what page does what and how;
...
- Each Markdown descriptions file should start with label of page name, category name and brief intro;
- Include the navigation instructions for each page Markdown description;
