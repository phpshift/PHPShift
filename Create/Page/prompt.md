...
2. "page.html" - (if needed) Responsive structure without inline styles and scripts;
3. "style.css" - (if needed) Responsive styles, generate if page needs to have styles;
4. "script.js" - (if needed) Handling complex actions;
5. "code.php" - (mandatory, even if no methods, class is required) Handling business logic;
N. "..." - (if needed) any other file e.g "items.json";
